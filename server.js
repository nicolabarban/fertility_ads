...
const DATA_PATH = process.env.SAMPLE_CSV_PATH || path.join(__dirname, "data", "sample200.csv");
...
const GROUND_TRUTH_PATH = path.join(DATA_DIR, "ground_truth.csv");
const REPRO_EXTRACT_PATH = path.join(DATA_DIR, "repro_extract.csv");
